...
axios.defaults.baseURL = 'https://jsonplaceholder.typicode.com' // Base URL for all requests
axios.defaults.headers.common['Authorization'] = 'AUTH_TOKEN' // Common headers are general headers set for all types of requests
...
axios.interceptors.request.use( requestConfig => {
  ...
  console.log(error) // Handle errors globally (Only request setting errors, bad urls won't me caught)
